...
namespace CrmEarlyBound
{
	...
	public partial class UoMSchedule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.AsyncOperation> UoMSchedule_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.AsyncOperation>("UoMSchedule_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("UoMSchedule_AsyncOperations");
				this.SetRelatedEntities<CrmEarlyBound.AsyncOperation>("UoMSchedule_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.PrincipalObjectAttributeAccess> uomschedule_PrincipalObjectAttributeAccesses
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.PrincipalObjectAttributeAccess>("uomschedule_PrincipalObjectAttributeAccesses", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("uomschedule_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<CrmEarlyBound.PrincipalObjectAttributeAccess>("uomschedule_PrincipalObjectAttributeAccesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.UserEntityInstanceData> userentityinstancedata_uomschedule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.UserEntityInstanceData>("userentityinstancedata_uomschedule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_uomschedule");
				this.SetRelatedEntities<CrmEarlyBound.UserEntityInstanceData>("userentityinstancedata_uomschedule", null, value);
		...
		public CrmEarlyBound.SystemUser lk_uomschedulebase_createdby
		{
			...
			set
			{
				...
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_uomschedulebase_createdby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_uomschedulebase_modifiedby
		{
			...
			set
			{
				...
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_uomschedulebase_modifiedby", null, value);
		...
		public CrmEarlyBound.Organization organization_uof_schedules
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_uof_schedules", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("organization_uof_schedules");
				this.SetRelatedEntity<CrmEarlyBound.Organization>("organization_uof_schedules", null, value);

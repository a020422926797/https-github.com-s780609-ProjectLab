...
namespace CrmEarlyBound
{
	...
	public partial class ProductPriceLevel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Microsoft.Xrm.Sdk.Money Amount_Base
		{
			...
			set
			{
				this.OnPropertyChanging("Amount_Base");
				this.SetAttributeValue("amount_base", value);
				this.OnPropertyChanged("Amount_Base");
			}
		}
		...
		public Microsoft.Xrm.Sdk.Money RoundingOptionAmount_Base
		{
			...
			set
			{
				this.OnPropertyChanging("RoundingOptionAmount_Base");
				this.SetAttributeValue("roundingoptionamount_base", value);
				this.OnPropertyChanged("RoundingOptionAmount_Base");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.AsyncOperation> ProductPriceLevel_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.AsyncOperation>("ProductPriceLevel_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ProductPriceLevel_AsyncOperations");
				this.SetRelatedEntities<CrmEarlyBound.AsyncOperation>("ProductPriceLevel_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.PrincipalObjectAttributeAccess> productpricelevel_PrincipalObjectAttributeAccesses
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.PrincipalObjectAttributeAccess>("productpricelevel_PrincipalObjectAttributeAccesses", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("productpricelevel_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<CrmEarlyBound.PrincipalObjectAttributeAccess>("productpricelevel_PrincipalObjectAttributeAccesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.ProcessSession> ProductPriceLevel_ProcessSessions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.ProcessSession>("ProductPriceLevel_ProcessSessions", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ProductPriceLevel_ProcessSessions");
				this.SetRelatedEntities<CrmEarlyBound.ProcessSession>("ProductPriceLevel_ProcessSessions", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.UserEntityInstanceData> userentityinstancedata_productpricelevel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.UserEntityInstanceData>("userentityinstancedata_productpricelevel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_productpricelevel");
				this.SetRelatedEntities<CrmEarlyBound.UserEntityInstanceData>("userentityinstancedata_productpricelevel", null, value);
		...
		public CrmEarlyBound.SystemUser lk_productpricelevelbase_createdby
		{
			...
			set
			{
				...
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_productpricelevelbase_createdby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_productpricelevelbase_modifiedby
		{
			...
			set
			{
				...
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_productpricelevelbase_modifiedby", null, value);
		...
		public CrmEarlyBound.ProcessStage processstage_productpricelevels
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.ProcessStage>("processstage_productpricelevels", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("processstage_productpricelevels");
				this.SetRelatedEntity<CrmEarlyBound.ProcessStage>("processstage_productpricelevels", null, value);

...
namespace CrmEarlyBound
{
	...
	public partial class RoleTemplatePrivileges : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("upgrading")]
		public System.Nullable<bool> Upgrading
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("upgrading");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Upgrading");
				this.SetAttributeValue("upgrading", value);
				this.OnPropertyChanged("Upgrading");
			}
		}

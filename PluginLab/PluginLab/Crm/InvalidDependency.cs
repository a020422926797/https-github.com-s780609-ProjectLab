...
namespace CrmEarlyBound
{
	...
	public partial class InvalidDependency : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<System.Guid> ExistingComponentId
		{
			...
			set
			{
				this.OnPropertyChanging("ExistingComponentId");
				this.SetAttributeValue("existingcomponentid", value);
				this.OnPropertyChanged("ExistingComponentId");
			}
		}
		...
		public Microsoft.Xrm.Sdk.OptionSetValue ExistingComponentType
		{
			...
			set
			{
				this.OnPropertyChanging("ExistingComponentType");
				this.SetAttributeValue("existingcomponenttype", value);
				this.OnPropertyChanged("ExistingComponentType");
			}
		}
		...
		public virtual ComponentType? ExistingComponentTypeEnum
		{
			...
			{
				this.OnPropertyChanging("ExistingComponentType");
				this.SetAttributeValue("existingcomponenttype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("ExistingComponentType");
			}
		}
		...
		public Microsoft.Xrm.Sdk.OptionSetValue ExistingDependencyType
		{
			...
			set
			{
				this.OnPropertyChanging("ExistingDependencyType");
				this.SetAttributeValue("existingdependencytype", value);
				this.OnPropertyChanged("ExistingDependencyType");
			}
		}
		...
		public virtual DependencyType? ExistingDependencyTypeEnum
		{
			...
			{
				this.OnPropertyChanging("ExistingDependencyType");
				this.SetAttributeValue("existingdependencytype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("ExistingDependencyType");
			}
		}
		...
		public System.Nullable<System.Guid> InvalidDependencyId
		{
			...
			set
			{
				this.OnPropertyChanging("InvalidDependencyId");
				this.SetAttributeValue("invaliddependencyid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("InvalidDependencyId");
			}
		}
		...
		public System.Nullable<bool> IsExistingNodeRequiredComponent
		{
			...
			set
			{
				this.OnPropertyChanging("IsExistingNodeRequiredComponent");
				this.SetAttributeValue("isexistingnoderequiredcomponent", value);
				this.OnPropertyChanged("IsExistingNodeRequiredComponent");
			}
		}
		...
		public string MissingComponentInfo
		{
			...
			set
			{
				this.OnPropertyChanging("MissingComponentInfo");
				this.SetAttributeValue("missingcomponentinfo", value);
				this.OnPropertyChanged("MissingComponentInfo");
			}
		}
		...
		public System.Nullable<int> MissingComponentLookupType
		{
			...
			set
			{
				this.OnPropertyChanging("MissingComponentLookupType");
				this.SetAttributeValue("missingcomponentlookuptype", value);
				this.OnPropertyChanged("MissingComponentLookupType");
			}
		}
		...
		public Microsoft.Xrm.Sdk.OptionSetValue MissingComponentType
		{
			...
			set
			{
				this.OnPropertyChanging("MissingComponentType");
				this.SetAttributeValue("missingcomponenttype", value);
				this.OnPropertyChanged("MissingComponentType");
			}
		}
		...
		public virtual ComponentType? MissingComponentTypeEnum
		{
			...
			{
				this.OnPropertyChanging("MissingComponentType");
				this.SetAttributeValue("missingcomponenttype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("MissingComponentType");
			}
		}
